...
Books already loaded (6): **Glow From Within** (skincare), **MANMADE** (grooming), **The Complete Aristotle** (philosophy/habits — curated to ~320 passages; → Aristotle legend voice), **Can't Hurt Me** / Goggins (psychology/toughness; → Goggins voice), **Beyond Bigger Leaner Stronger** / Matthews (gym/training/nutrition; → Arnold voice), **No More Mr. Nice Guy** / Glover (masculine/social/boundaries; → new Glover legend voice). Ravi has ~3 more to upload, 2 at a time. Legends now total 8 (see `lib/legends.ts`); `legendForFocus` routes social/communication/boundaries/masculinity → glover, gym/strength → arnold, study/virtue/wisdom → aristotle, toughness/pain → goggins.
